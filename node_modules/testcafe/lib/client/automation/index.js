...
(function () {
    ...
    ***************************************************************************** */
    ...
    var ProxylessEventSimulator = /** @class */ (function () {
        function ProxylessEventSimulator(dispatchEventFn) {
    ...
    var VisibleElementAutomation = /** @class */ (function (_super) {
        ...
        function VisibleElementAutomation(element, offsetOptions, win, cursor, dispatchProxylessEventFn) {
            var _this = _super.call(this) || this;
            ...
            _this.window = win;
            _this.cursor = cursor;
            _this.proxylessEventSimulator = dispatchProxylessEventFn ? new ProxylessEventSimulator(dispatchProxylessEventFn) : null;
        ...
        VisibleElementAutomation.prototype.canUseProxylessEventSimulator = function (element) {
            return !!this.proxylessEventSimulator
                ...
                && !hammerhead.utils.dom.isIframeWindow(this.window);
        };
    ...
    var ClickAutomation = /** @class */ (function (_super) {
        ...
        function ClickAutomation(element, clickOptions, win, cursor, dispatchProxylessEventFn) {
            var _this = _super.call(this, element, clickOptions, win, cursor, dispatchProxylessEventFn) || this;
