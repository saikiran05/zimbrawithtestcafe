    ...
    ***************************************************************************** */
    ...
    var NativeDialogTracker = /** @class */ (function () {
        function NativeDialogTracker(contextStorage, _a) {
            var _b = _a === void 0 ? {} : _a, proxyless = _b.proxyless, dialogHandler = _b.dialogHandler;
        ...
        NativeDialogTracker.prototype._init = function (proxyless) {
            var _this = this;
            if (proxyless) {
                ['alert', 'confirm', 'prompt'].forEach(function (dialogType) {
                    _this.nativeHandlers[dialogType] = window[dialogType];
                });
            }
        ...
        NativeDialogTracker.prototype._createDialogHandler = function (type) {
            ...
            return function (text) {
                ...
                if (_this.nativeHandlers[type])
                    _this.nativeHandlers[type].call(window, text);
                return result;
            };
        };
        // Overridable methods
    ...
    var StorageStrategy = /** @class */ (function () {
        function StorageStrategy(window, testRunId, windowId) {
        ...
        StorageStrategy.prototype._createStorageKey = function (testRunId, windowId) {
            var storageKey = STORAGE_KEY_PREFIX + testRunId;
            if (windowId)
                return storageKey + '|' + windowId;
            return storageKey;
        };
        StorageStrategy.prototype.loadFromStorage = function () {
            var res = {};
    ...
    var StorageStrategyProxyless = /** @class */ (function (_super) {
        ...
        function StorageStrategyProxyless() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        StorageStrategyProxyless.prototype._getData = function () {
            return _super.prototype._getData.call(this) || window[PROXYLESS_STORAGE_KEY];
        };
        StorageStrategyProxyless.prototype._deleteData = function () {
            _super.prototype._deleteData.call(this);
        ...
        StorageStrategyProxyless.prototype.save = function (data) {
            ...
            if (window.PROXYLESS_STORAGE_BINDING)
                window.PROXYLESS_STORAGE_BINDING(JSON$1.stringify(data));
        };
    ...
    ActionExecutor.ACTIONS_HANDLERS[COMMAND_TYPE.click] = {
        create: function (command, elements, dispatchProxylessEventFn) {
            ...
            return new testcafeAutomation.Click(elements[0], command.options, window, testcafeAutomation.cursor, dispatchProxylessEventFn);
        },
    };
    ...
    var Driver = /** @class */ (function (_super) {
        ...
        Driver.prototype._onActionCommand = function (command) {
            ...
            var dispatchProxylessEventFn = this.options.proxyless
                ? testcafeCore.browser.dispatchProxylessEvent.bind(testcafeCore.browser.dispatchProxylessEvent, this.communicationUrls.dispatchProxylessEvent, hammerhead__default.createNativeXHR)
                : null;
